...
import { EditProduct, EditProductForm } from './EditProduct';

describe('Test EditProduct with shallow rendering', () => {
    let wrapper;
    ...
    beforeEach(() => {
        wrapper = shallow(<EditProduct {...props}/>);
    });
    ...
    it('should render a EditProductForm component', () => {
        expect(wrapper.dive().find(EditProductForm).length).toEqual(1);
    })
